  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        typescript = { 'eslint_d', 'deno_fmt', stop_after_first = true, async = true },
        -- typescriptreact = { 'eslint_d', 'deno', stop_after_first = true, async = true },
        typescriptreact = { 'eslint_d', 'deno_fmt', stop_after_first = true },
        css = { 'eslint_d', 'deno_fmt', stop_after_first = true, async = true },
